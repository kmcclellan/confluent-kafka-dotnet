...
namespace Confluent.Kafka
{
    ...
    internal class Producer<TKey, TValue> : IProducer<TKey, TValue>, IClient
    {
        ...
        private async void ProduceImpl(TopicPartition topicPartition, Message<TKey, TValue> message, IDeliveryHandler handler)
        {
            ...
            CancellationToken cancellationToken)
        {
            if (enableDeliveryReports)
            {
                ...
                ProduceImpl(topicPartition, message, handler);
                return handler.Task;
            }
            else
            {
                ProduceImpl(topicPartition, message, null);
